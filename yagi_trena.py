...
director_length2 = 860
director_dist2 = director_dist + 400 # Posição total = 800 mm
...
mesh.AddLine("x", [-reflector_dist, director_dist, director_dist2]) # Adicionado director_dist2
...
director_arm2: CSPropMetal = csx.AddMetal("director_arm2")
director_arm2.AddLinPoly(points=Trena.translate_to(director_dist2, 0), norm_dir='z', elevation=-director_length2/2, length=director_length2)
director_arm2.SetColor("#ff0000", 50) # usei a mesma cor
